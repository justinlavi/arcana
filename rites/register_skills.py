...
GENERATED_SOURCE_RE = re.compile(
    r"<!--\s*GENERATED - source:\s*(.*?)\s*\|\s*DO NOT EDIT this file\.",
    re.DOTALL,
)
...
def normalized_path_text(path_text: str | Path) -> str:
    ...
    return str(path_text).strip().replace("\\", "/").rstrip("/").casefold()
...
def apply_registration_plan(plan: dict[str, Any], skills_target: Path, pointer_only: bool) -> tuple[int, int]:
