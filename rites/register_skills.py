...
GENERATED_SOURCE_RE = re.compile(
    # Tolerate hyphen, en-dash, and em-dash separators: earlier rite versions
    # emitted an em-dash here, and those legacy generated skills must stay
    # provably Arcana-owned so a rename or format upgrade can clean them up
    # mechanically instead of stranding an orphan.
...
def insert_ownership_comment(content: str, spec: SkillSpec) -> str:
    ...
    provenance = (
        ...
        "DO NOT EDIT this file. Edit the source and run /arc-agent-sync-skills. -->"
    )
