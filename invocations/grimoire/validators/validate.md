...
`/grm-audit-boundaries`, or `/grm-improve`.
...
- Validator hub -> [[invocations/grimoire/validators/validators|validators]]
- Semantic audit -> [[invocations/grimoire/audit_semantics|audit semantics]]
