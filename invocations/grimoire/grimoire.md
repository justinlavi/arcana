...
| [[invocations/grimoire/agent_sync_skills|agent sync skills]] | `/grm-agent-sync-skills` | Sync Arcana skills and the active grimoire's own skills |
...
| [[invocations/grimoire/validators/validate|validate]] | `/grm-validate` | Mechanical validators for active grimoires |
...
7. Refresh skills: `/grm-agent-sync-skills` after editing grimoire `skills/`.
