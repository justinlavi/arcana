...
| [update_arcana.md](update_arcana.md) | `/grm-update-arcana` | Pull the latest Arcana, refresh agent integration, re-register skills, and check active-grimoire health |
...
| [validators/validate_all.md](validators/validate_all.md) | `/grm-validate-all` | Full deterministic validator profile for active grimoires |
...
8. **Audit**: run `/grm-validate-all`, then invoke individual analysis skills as needed.
