...
# Invocation: Audit Semantic Clarity
...
- As an explicit pre-release or restructure audit (not auto-invoked)
...
- **Apply changes**: `/grm-health-check`
- **Structure validation**: `/grm-validate structure`
- **Boundary validation**: `/grm-audit-boundaries`
