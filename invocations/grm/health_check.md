...
- Scaffold and structure upgrade: `/grm-update` — brings the managed scaffold current; this health-check adds the knowledge-quality passes (stale claims, ghost references, contradictions, missing cross-refs) that the update does not run
