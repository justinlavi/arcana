...
- **Where from** — written fresh in conversation, or distilled from the current
  ...
  use [[invocations/grm/import|import]] (`/grm-import`) — that is the
...
- **Grimoire creation**: [[invocations/grm/create_grimoire|create grimoire]]
- **External sources**: [[invocations/grm/import|import]]
