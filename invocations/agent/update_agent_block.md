...
This skill updates instruction files only. If the user also needs newly added skills to appear in slash-command pickers, run or recommend `/arc-agent-register-skills` separately.
