...
For the public command workflow, see [[invocations/arcana/validators/validate|validate]].
...
Or invoke `/arc-validate`, whose workflow home is [[invocations/arcana/validators/validate|validate]].
