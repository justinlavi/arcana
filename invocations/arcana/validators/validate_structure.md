...
To validate a **domain grimoire's** structure instead, use `/grm-domain-validate-structure` — that one operates on the active grimoire directory rather than on Arcana.
