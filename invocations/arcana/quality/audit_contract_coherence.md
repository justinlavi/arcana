...
(`/grm-repair-links`, `/arc-library-sync`, `/arc-library-adopt`,
`/arc-workspace-clean`); `append_log` is internal. The validator family also
...
[[invocations/arcana/quality/review_architecture|review architecture]]. When
...
- **Not `validate_rites`** ([[invocations/arcana/quality/validate_rites|validate
...
- **Not `review_architecture`**
  ([[invocations/arcana/quality/review_architecture|review architecture]], Phase
...
- Rite quality (Phase 4): [[invocations/arcana/quality/validate_rites|validate rites]]
- Architecture review (Phase 3): [[invocations/arcana/quality/review_architecture|review architecture]]
