...
- **Validators**: [[invocations/arc/validators/validators|validators]] and `/arc-validate`
- **Rite quality**: [[invocations/arc/quality/validate_rites|validate rites]] (rite-specific checks; complementary)
