...
- Internal links use markdown for cross-doc references and `[[wikilinks]]` for hub-internal navigation. [rites/validate_links.py](rites/validate_links.py) checks both.
