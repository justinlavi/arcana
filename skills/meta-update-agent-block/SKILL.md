---
name: {{NAMESPACE}}-meta-update-agent-block
description: Refresh the Grimoire instruction block in user agent files while preserving non-Grimoire content
...
!`cat {{ARCANA_PATH}}/invocations/meta/update_agent_block.md`
