...
when_to_use: Before committing changes that touched docs, invocations, or formulae; as a phase of `/arc-improve`; user mentions "format check" or "is this markdown well-formed". Cheap and read-only.
user-invocable: true
...
You are running the format validator against the Arcana repository (not against grimoires - this is an Arcana-internal check).
