...
You are bringing content into the active domain grimoire. The skill is polymorphic and routes content to the right destination based on what it is. Follow the invocation guide below.
