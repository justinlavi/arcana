---
name: {{SKILL_PREFIX}}-agent-register-skills
...
- **Arcana**: `{{ARCANA_PATH}}`
- **Invocation**: `{{ARCANA_PATH}}/invocations/agent/register_skills.md`

## Invocation

!`cat {{ARCANA_PATH}}/invocations/agent/register_skills.md`
