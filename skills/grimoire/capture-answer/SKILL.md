---
name: {{SKILL_PREFIX}}-capture-answer
description: Capture a substantive chat answer as a properly-frontmattered wiki page
...
!`cat {{ARCANA_PATH}}/invocations/grimoire/capture_answer.md`
