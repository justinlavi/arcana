...
- Arcana itself is excluded from the library scan (it's the engine, not a domain grimoire) — the rite recognizes it by `name: "arcana"` in `arcana/grimoire.json`.
