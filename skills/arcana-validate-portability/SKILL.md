---
name: {{NAMESPACE}}-arcana-validate-portability
...
You are running the filesystem-portability checker against the Arcana repository (or, when the working directory is a domain grimoire, against that grimoire).
