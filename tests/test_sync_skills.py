...
def test_sync_skills_updates_generated_provenance_without_marker(tmp_path, monkeypatch):
    ...
    existing = target / "arc-help"
    existing.mkdir(parents=True)
    source_dir = sync_skills.ARCANA_PATH / "skills" / "help" / "help"
...
def test_sync_skills_cleans_legacy_em_dash_orphan(tmp_path, monkeypatch):
    ...
    gone_source = sync_skills.ARCANA_PATH / "skills" / "arcana" / "renamed-away"
...
def test_sync_skills_cleans_only_owned_stale_entries(tmp_path, monkeypatch):
    ...
    retired_source = sync_skills.ARCANA_PATH / "skills" / "arcana" / "retired"
