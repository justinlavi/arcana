...
| [`source.formula.md`](source.formula.md) | A `type: source` wrapper under `sources/` with capture metadata, source body, or a pointer to a sibling raw artifact. | `/grm-ingest` |
